...
export const blogPost = [
  {
    title:
      "Transforming Healthcare with AI: How Neunorth is Empowering Better Patient Outcomes",
    content:
      "This blog post explores Neunorth’s impact on healthcare through AI-powered solutions, such as predictive analytics and machine learning tools that help medical professionals make data-driven decisions and optimize patient care.",
    image: blog1,
  },
  {
    title:
      "Protecting Businesses from Cyber Threats: Neunorth’s Approach to Modern Cybersecurity",
    content:
      "Discuss Neunorth’s cybersecurity solutions, highlighting advanced threat detection, machine learning in threat analysis, and proactive defense strategies that businesses can adopt to secure their data in an increasingly digital landscape.",
    image: blog2,
  },
  {
    title:
      "Building Smart Cities with IoT: Neunorth’s Vision for Sustainable Urban Development",
    content:
      "This blog post dives into how Neunorth is leveraging IoT to enable smart city infrastructure. Discuss IoT’s role in making cities more efficient, sustainable, and data-centric, with examples of how Datawave’s solutions have been implemented in urban development projects.",
    image: blog3,
  },
];
